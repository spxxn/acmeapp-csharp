...
namespace Acme.Biz
{
    ...
    public class Vendor 
    {
        ...
        /// <returns></returns>
        /// kept below to show overloading pulling from one to another
        ...
        /// <returns></returns>
        /// kept below to show pulling one overloaded parameter off of another
        //public OperationResult PlaceOrder(Product product, int quantity,
        ...
        {
            //guard clauses .. also nameof features if fairly new
            if (product == null)
        ...
        /// <param name="sendCopy">True to send a copy of the email copy.</param>
